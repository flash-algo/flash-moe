...
There are several ways you can contribute to **flash-moe**:

* Fix outstanding issues with the existing kernels or tests.
* Submit issues related to bugs or desired new features.
* Improve implementations for readability, numerical stability, or performance.
* Contribute to the docs, examples, or benchmarks.
...
If there is a new feature you'd like to see in flash-moe, please open an issue and describe:
...
You will need basic `git` proficiency to contribute to flash-moe. You'll need **Python 3.8+** and a recent **PyTorch** installation; CUDA is required only if you want to run GPU backends.

### Development Setup

1. Fork the [repository](https://github.com/flash-algo/flash-moe) by clicking on the **Fork** button.

2. Clone your fork to your local disk, and add the base repository as a remote:

   ```bash
   git clone https://github.com/<your Github handle>/flash-moe.git
   cd flash-moe
   git remote add upstream https://github.com/flash-algo/flash-moe.git
   ```
...
5. Develop the features in your branch.
   ...
   ```bash
   pytest tests/<TEST_TO_RUN>.py -q
   ```

   To keep the codebase consistent, flash-moe relies on **black** and **ruff** for formatting and linting. After you make changes, you can apply automatic style fixes and basic checks only on the files modified on your branch with:
...
Thank you for contributing to flash-moe! 🚀
